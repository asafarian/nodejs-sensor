...
describe('Process processor', function() {
  ...
  it('should provide payload when ready', () => {
    ...
    return retry(() => {
      ...
      expect(payload.data.cpu).to.exist;
  ...
  it('should emit ready event', () => {
    ...
    return retry(() => {
      ...
      expect(emittedPayload.data.cpu).to.exist;
      expect(emittedPayload.data.cpu.user).to.be.a('number');
      expect(emittedPayload.data.cpu.sys).to.be.a('number');
    });
  });
